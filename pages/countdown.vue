...
let dateToCountDown = new Date('2023-02-20T00:00:00+0100');

let secondsTillOpen = ref(Math.floor((dateToCountDown.getTime() - new Date().getTime()) / 1000));
